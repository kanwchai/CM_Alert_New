...
//        dbMyDatabase = new MyDatabase(context);
//    }
//
//    @Override
...
//                + TB_1_CAR.Type_Car_Id + " INTEGER REFERENCES " +
...
//                + TB_2_DUE_OF_PART_FIX.Part_Id + " INTEGER REFERENCES " +
...
//                + TB_3_DUE_OF_PART_STANDART.Part_Id + " INTEGER REFERENCES " +
//                TB_5_PARTS.TABLE + "(" + TB_5_PARTS.Part_Id + ") ON UPDATE CASCADE, "
...
//                + TB_4_HISTORYS_OF_CAR.Fix_Due_Id + " INTEGER REFERENCES " +
//                TB_2_DUE_OF_PART_FIX.TABLE + "(" + TB_2_DUE_OF_PART_FIX.Fix_Due_Id + ") ON UPDATE CASCADE, "
//                + TB_4_HISTORYS_OF_CAR.Car_Id + " INTEGER REFERENCES " +
//                TB_1_CAR.TABLE + "(" + TB_1_CAR.Car_Id + ") ON UPDATE CASCADE, "
...
//                + TB_6_RUN_DATA.Car_Id + " INTEGER REFERENCES " +
//                TB_1_CAR.TABLE + "(" + TB_1_CAR.Car_Id + ") ON UPDATE CASCADE, "
